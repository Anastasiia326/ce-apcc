  ...
  return (
    <div className="container mx-auto grid grid-cols-1 xl:grid-cols-2 gap-20 px-4 mb-20">
      <div className="col-span-1">
        ...
        <Link to="/news/detail/1" className="relative flex flex-row items-center w-fit z-10 text-[#1BAE70] hover:text-[#333333] text-2xl xl:text-3xl font-normal leading-[40px] mx-auto xl:mx-0">
