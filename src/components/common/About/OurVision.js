  ...
  return (
    <div className="our-vision relative mb-8 xl:mb-[240px]">
      ...
      <div className="container relative xl:absolute left-1/2 -translate-x-1/2 xl:-bottom-[25%]">
        <div className="text-xl md:text-4xl text-white font-bold italic text-center leading-[28px] md:leading-[70px] bg-[#1BAE70] rounded-lg p-4 md:p-8 p-4 lg:p-24 m-4">
          ...
          <p className="not-italic text-2xl md:text-2xl text-right font-normal leading-[70px] my-4">Dr Kobus Herbst</p>
          <img src={Quote} alt="Quote" className="mx-auto"/>
        </div>
      </div>
    </div>
