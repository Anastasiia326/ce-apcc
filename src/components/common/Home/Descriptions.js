    ...
    <div className="descriptions py-2 mb-20">
      <div className="container mx-auto px-4">
        ...
        <TextAndImage className="mt-16 lg:mt-32 py-2" imgPath={Collaborators} alt="Collaborators">
          <Link to="/resource" className="relative z-10 text-[#333333] hover:text-[#1BAE70]"><h1 className="text-3xl xl:text-5xl font-bold leading-[40px] xl:leading-[60px] py-7">Collaborators</h1></Link>
        ...
        <TextAndImage className="mt-16 lg:mt-32 py-2" imgPath={Resources} alt="Resources">
          <Link to="/collaborators" className="relative z-10 text-[#333333] hover:text-[#1BAE70]"><h1 className="text-3xl xl:text-5xl font-bold leading-[40px] xl:leading-[60px] py-7">Resources</h1></Link>
